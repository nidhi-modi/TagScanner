...
import com.tandg.rf_reader_writer.NdefMessageParser
import com.tandg.tagscanner.R
import com.tandg.tagscanner.Utils
...
class ReadNfc : AppCompatActivity() {
    ...
    private var textPrevious: TextView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textPrevious = findViewById<View>(R.id.text2) as TextView
